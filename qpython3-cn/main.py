...
import sl4a, sys, time, socket, urllib, http.cookiejar, sqlite3, json, hashlib
droid = sl4a.Android()
...
locBaseUrl = 'https://test.test.info/'
...
def startRecordAudio():
  des = locBaseDir + "data/audio/" + geoData['timestamp'] + ".wav"
  print(des)
  droid.recorderStartMicrophone(des)
  # time.sleep(10)
...
while True:
  ...
  elif event ['name' ] == 'startRecordAudio' :
    startRecordAudio()
  elif event ['name' ] == 'stopRecord' :
    stopRecord()
